...
gulp.task('font', function () {
    return gulp.src([
        ...
        .pipe(gulp.dest('public/web/fonts'));
});
...
gulp.task('watch', function () {
    ...
    gulp.watch('public/web/*.html', ['html']);
     ...
     */
    gulp.watch(['public/web/js/**']).on('change', livereload.changed);
    gulp.watch(['public/web/img/**']).on('change', livereload.changed);
    gulp.watch(['public/web/css/**']).on('change', livereload.changed);
    gulp.watch(['public/web/*.html']).on('change', livereload.changed);
});
